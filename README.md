...
| **Protocol coverage** | ⚪ **458 protocols** — broad coverage, but decode depth varies: some are fully parsed, others recognised and labelled | ✅ **~3000** — unmatched breadth and decode depth |
...
- **🗂 458 protocols out of the box** — from everyday (DNS, HTTP/2, TLS, QUIC, SMB, RDP)
  ...
  > The registry declares a further 2,070 protocol names that no dissector produces
