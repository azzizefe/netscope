...
/// filter on â€” but never observe. This field is what keeps a row from making a
...
pub enum Support {
    ...
    /// then change this to `Dissected` â€” the test will tell you if you forget
    /// either half.
    Declared,
}
...
/// through an alias, so nothing broke visibly â€” the alias requirement simply
...
macro_rules! protocols {
    ($(
        ...
        impl Protocol {
            ...
            /// The protocols a capture can actually contain â€” every row whose
            ...
            /// [`declared_status_matches_the_dispatch`] â€” the field cannot
...
protocols! {
    ...
    Utp {
        ...
        blurb:     "A BitTorrent transfer (Ã‚ÂµTP)  â€”  file sharing over a transport designed to get out of the way of other traffic.",
    }
    Nflog {
    ...
    OpcUaDpi {
        doc:       "OPC UA Deep Packet Inspection (DPI) â€” full binary UA-TCP protocol analysis.",
        display:   "OPC UA DPI",
        color:     0x307070,
        transport: Tcp,
        rank:      4,
    ...
    OpcUaSecureConv {
        doc:       "OPC UA SecureConversation â€” hybrid security message layer.",
    ...
    OpcUaBinaryDetail {
        doc:       "OPC UA Binary encoding detail dissector â€” NodeId, Variant, ExtensionObject parsers.",
    ...
    TlsPqcHandshakeExt {
        ...
        blurb:     "TLS PQC Handshake Ext â€” TLS 1.3 PQC handshake extension dissector for hybrid KEM parsing of supported_groups, key_share, and signature_algorithms extensions carrying post-quantum identifiers.",
    }
    TlsPqcCertChain {
        ...
        blurb:     "TLS PQC Cert Chain â€” X.509 PQC composite certificate chain parser extracting traditional (ECDSA/RSA) and post-quantum (ML-DSA/SLH-DSA) signature certificates from TLS Certificate messages.",
    }
    TlsPqcMigrationSignal {
        ...
        blurb:     "TLS PQC Migration Signal â€” PQC migration signaling extension per RFC draft for negotiating PQC readiness, capability advertisement, and fallback mechanisms between TLS peers.",
    }
    TlsPqcWizardScan {
        ...
        blurb:     "TLS PQC Wizard Scan â€” bulk scanning engine that aggregates PQC handshake records, runs vulnerability rules, and generates a comprehensive PQC readiness report with CVSS-scored findings and compliance flags per NIST SP 800-131A/BSI TR-02102/ANSSI/CNSA 2.0.",
    }
    TlsCertTransparencyV3 {
        ...
        blurb:     "TLS Cert Transparency v3 â€” Certificate Transparency v3 PQC-aware Signed Certificate Timestamp (SCT) parser for post-quantum certificate logs with ML-DSA and SLH-DSA signature verification.",
    }
    TlsEchPqcInterop {
        ...
        blurb:     "TLS ECH PQC Interop â€” Encrypted Client Hello (ECH) + PQC compatibility testing protocol that validates KEM negotiation through ECH-encrypted extensions and detects PQC-unaware middlebox interference.",
    }
    TlsKeySharePrediction {
        ...
        blurb:     "TLS Key Share Prediction â€” key share negotiation failure prediction and reporting protocol analyzing KEM offer/response mismatches, hybrid stripping, and fallback patterns from PQC handshake records.",
    }
    TlsDowngradeDetector {
        ...
        blurb:     "TLS Downgrade Detector â€” TLS downgrade attack detection engine feed that identifies version rollback (TLS 1.3 â†’ 1.2), KEM stripping, and hybrid-to-classic downgrade attacks from PQC handshake records.",
    }
    PqcCveFeedIntegration {
        ...
        blurb:     "PQC CVE Feed Integration â€” NIST NCCoE PQC CVE feed integration protocol that cross-references detected KEM algorithms against known post-quantum CVEs for timing side-channels, weak parameters, and constant-time violations.",
    }
    TlsPerfBenchmarkModel {
        ...
        blurb:     "TLS Perf Benchmark Model â€” TLS handshake performance benchmark model data dissector that measures classic vs PQC handshake latency, KEM computation time, bandwidth overhead, and throughput impact from real session data.",
    }
    TlsMiddleboxDetector {
        ...
        blurb:     "TLS Middlebox Detector â€” TLS middlebox interference detection protocol that identifies oversized handshake messages, protocol anomalies, hybrid KEM stripping, and PQC rejection patterns indicative of middlebox tampering.",
    }
    PqcComplianceChecker {
        ...
        blurb:     "PQC Compliance Checker â€” multi-standard compliance checker that evaluates PQC handshake data against NIST SP 800-131A, BSI TR-02102, ANSSI PQC, NSA CNSA 2.0, and ETSI TS 119 312 frameworks for regulatory readiness.",
    }
    TlsSessionResumptionPqc {
        ...
        blurb:     "TLS Session Resumption PQC â€” PQC-aware session resumption (PSK) analysis protocol that examines 0-RTT data, PSK modes, and KEM bindings for post-quantum session ticket and external PSK negotiation.",
    }
    Ikev2PqcDhGroup {
        ...
        blurb:     "IKEv2 PQC DH Group â€” IKEv2 PQC Diffie-Hellman group negotiation dissector for post-quantum key exchange in IPsec IKEv2 with ML-KEM and FrodoKEM transform attributes.",
    }
    WireguardPqcHandshake {
        ...
        blurb:     "WireGuard PQC Handshake â€” WireGuard PQC handshake extension with KEM-based post-quantum key exchange wrapping the standard Curve25519 Noise handshake for quantum-resistant tunnel establishment.",
    }
    SshPqcKex {
        ...
        blurb:     "SSH PQC KEX â€” OpenSSH 9.x post-quantum key exchange using sntrup761x25519-sha512 (Streamlined NTRU Prime 761 + X25519 hybrid) for quantum-resistant SSH session key agreement.",
    }
    DnssecPqcSigning {
        ...
        blurb:     "DNSSEC PQC Signing â€” DNSSEC post-quantum signing algorithm dissection for RRSIG records using Falcon-512/1024 or Dilithium (ML-DSA) signatures for quantum-resistant DNS zone signing and validation.",
    }
    PqcCertTransparency {
        ...
        blurb:     "PQC Cert Transparency â€” Certificate Transparency with post-quantum hybrid Signed Certificate Timestamps (SCT) using ML-DSA or SLH-DSA signatures for quantum-resistant certificate log verification.",
    }
    OqsProviderTelemetry {
        ...
        blurb:     "OQS Provider Telemetry â€” Open Quantum Safe (OQS) provider telemetry protocol for reporting PQC algorithm availability, performance benchmarks, and provider version information from OQS-enabled TLS stacks.",
    }
    PqcHsmBridge {
        ...
        blurb:     "PQC HSM Bridge â€” PQC-capable HSM-to-application bridge protocol for post-quantum key generation, signing, and key encapsulation operations offloaded to hardware security modules with ML-KEM, ML-DSA, and SLH-DSA support.",
    }
    ...
    CanopenNmt {
        ...
        blurb:     "CANopen NMT â€” CANopen Network Management protocol for node state control with Start/Stop/Reset commands, boot-up messages, and state machine transitions between Initialisation, Pre-Operational, Operational, and Stopped modes.",
    }
    CanopenPdo {
        ...
        blurb:     "CANopen PDO â€” CANopen Process Data Object protocol for real-time cyclic data exchange with up to 8 bytes of process data per PDO, supporting synchronous/asynchronous transmission and 4 receive + 4 transmit PDO channels.",
    }
    CanopenSdo {
        ...
        blurb:     "CANopen SDO â€” CANopen Service Data Object protocol for acyclic configuration access using index/subindex addressing, supporting expedited/segmented/block upload and download with comprehensive abort code reporting.",
    }
    Bb84QkdClassical {
    ...
    MilvusSealedSegStream {
        ...
        blurb:     "Milvus sealed segment streaming protocol â€” chunked streaming of sealed segment data from data nodes to query nodes, including vector fields, scalar fields, and deletion bitmaps.",
    }
    EdgeInferenceOnnx {
        ...
        blurb:     "ONNX Runtime edge inference IPC protocol â€” high-performance machine learning model inference using ONNX Runtime on edge devices, with session management, tensor I/O, and hardware accelerator binding.",
    }
    EdgeTensorflowLite {
        ...
        blurb:     "TensorFlow Lite Micro inference protocol â€” lightweight ML inference for microcontrollers and edge devices, with quantized model execution, tensor arena management, and interpreter control.",
    }
    EdgePytorchMobile {
        ...
        blurb:     "PyTorch Mobile/Lite interpreter IPC protocol â€” on-device ML inference using PyTorch's optimized mobile runtime, with model serialization, tensor transport, and delegate dispatching.",
    }
    NxpEiqInference {
        ...
        blurb:     "NXP eIQ edge intelligence inference protocol â€” NXP's ML inference stack for i.MX RT and LPC MCUs, with delegate dispatch to NPU, DSP, and CPU backends.",
    }
    StmStm32cubeAi {
        ...
        blurb:     "STMicroelectronics STM32Cube.AI runtime protocol â€” AI model inference on STM32 MCUs using X-CUBE-AI, with neural network activation, memory pooling, and peripheral integration.",
    }
    SiemensIndustrialEdge {
        ...
        blurb:     "Siemens Industrial Edge runtime app-to-app IPC protocol â€” inter-application communication on Siemens Industrial Edge devices, with app lifecycle, data pipeline, and OPC UA bridge integration.",
    }
    BoschNexeedEdge {
        ...
        blurb:     "Bosch Nexeed edge analytics transport protocol â€” real-time production data analytics transport for Bosch Nexeed Industrial Application System, with sensor fusion and predictive maintenance streams.",
    }
    BeckhoffTwincatAnalytics {
        ...
        blurb:     "Beckhoff TwinCAT Analytics data streaming protocol â€” real-time data acquisition and analysis for Beckhoff TwinCAT systems, with cyclic data streaming, event-triggered logging, and cloud connectivity.",
    }
    RockwellFactorytalkEdge {
        ...
        blurb:     "Rockwell FactoryTalk Edge Gateway protocol â€” edge-to-cloud data transport for Rockwell Automation's FactoryTalk ecosystem, with tag-based data publishing, alarm/event forwarding, and secure tunneling.",
    }
    SchneiderEcostruxureEdge {
        ...
        blurb:     "Schneider EcoStruxure edge-to-cloud bridge protocol â€” secure data exchange between EcoStruxure Automation Expert edge devices and cloud analytics platforms, with asset model synchronization and time-series ingestion.",
    }
    ...
    IoLink {
        ...
        blurb:     "IO-Link (IEC 61131-9) â€” point-to-point communication protocol for smart sensors and actuators with cyclic process data exchange, acyclic on-request data (ISDU), and event-driven diagnostics.",
    }
    AsInterface {
        ...
        blurb:     "AS-Interface (Actuator-Sensor Interface) â€” two-wire fieldbus for binary sensors and actuators with cyclic I/O data exchange, master-slave polling, and safety monitor extensions.",
    }
    Interbus {
        ...
        blurb:     "INTERBUS â€” Phoenix Contact's shift-register-based fieldbus for cyclic process data, parameter channel access, and TCP/IP encapsulation for remote diagnostics and configuration.",
    }
    ControlNet {
        ...
        blurb:     "ControlNet â€” Rockwell Automation deterministic control network using CTDMA (Concurrent Time Domain Multiple Access) with scheduled I/O, unscheduled messaging, and redundant media support.",
    }
    Mechatrolink {
        ...
        blurb:     "MECHATROLINK â€” Yaskawa motion control fieldbus with cyclic position/velocity/torque commands, synchronous axes coordination, and distributed servo drive control over RS-485 (M-I/II) or Ethernet (M-III/IV).",
    }
    VaranBus {
        ...
        aliases:   ["varan_bus"],
        blurb:     "VARAN Bus â€” Versatile Automation Random Access Network real-time Ethernet fieldbus for deterministic machine control with cyclic I/O, event-driven messaging, and fail-safe safety communication.",
    }
    PNet {
        ...
        blurb:     "P-NET â€” multi-master token-passing fieldbus for process automation with segmented addressing, acyclic client-server services, and UDP/IP encapsulation for remote access and diagnostics.",
    }
    Fsoe {
        ...
        blurb:     "FSoE (Fail Safe over EtherCAT) â€” functional safety protocol embedded within EtherCAT datagrams for SIL 3 safety communication with connection monitoring, CRC integrity, and watchdog-based fail-safe state transitions.",
    }
    Profidrive {
        ...
        blurb:     "PROFIdrive â€” application profile for drive technology over PROFIBUS and PROFINET with standardized parameter access, cyclic setpoint/actual value exchange, and isochronous axis control.",
    }
    ...
    ProfinetRtSiemens {
        ...
        blurb:     "Siemens PROFINET RT extended frame â€” real-time cyclic I/O data with Siemens-specific alarm channel, diagnosis subframes, and extended status information beyond the base PROFINET specification.",
    }
    ProfinetIrtSiemens {
        ...
        blurb:     "Siemens PROFINET IRT (Isochronous Real-Time) â€” deterministic isochronous communication for high-precision motion control with Siemens sync domain extensions, jitter compensation, and drive clock alignment beyond the standard IRT profile.",
    }
    ProfibusDpSiemens {
        ...
        blurb:     "Siemens PROFIBUS DP V2/V3 extensions â€” acyclic DP-V2 services for parametrization, alarm handling, and isochronous slave-to-slave communication with Siemens-specific FDL status, extended diagnostic data, and redundancy management.",
    }
    S7commPlusDetail {
        ...
        blurb:     "Siemens S7Comm Plus (TIA Portal v13+) â€” detailed decode of the enhanced job/ack mechanism, session multiplexing, encrypted payload negotiation, and firmware-version-specific protocol extensions (v4.0+) used by modern S7-1200/1500 controllers.",
    }
    SinamicsDriveProfile {
        ...
        blurb:     "Siemens SINAMICS drive profile â€” Siemens-specific PROFIdrive extensions including encoder emulation with virtual encoder mapping, safety limited speed (SLS) telegrams, dynamic drive control word extensions, and parameter access over the DPV1 acyclic channel.",
    }
    SimaticHmiSmartsrv {
        ...
        blurb:     "Siemens SIMATIC HMI SmartServer â€” WinCC RT Advanced tag streaming protocol with cyclic tag value publication, alarm/event forwarding, historical data retrieval, and multi-client session management for HMI visualization networks.",
    }
    SinumerikNckChannel {
        ...
        blurb:     "Siemens SINUMERIK NCK channel protocol â€” CNC-specific G-code streaming with block-by-block execution, tool management (tool offsets, wear, magazine assignment), axis position setpoint/actual exchange, and synchronized multi-channel coordination.",
    }
    ScalanceXRing {
        ...
        blurb:     "Siemens SCALANCE X HRP (High-Speed Redundancy Protocol) â€” industrial Ethernet ring redundancy with sub-50ms failover, ring port status monitoring, topology change notification, and configuration synchronization for SCALANCE X managed switches.",
    }
    SiemensL2Telegram {
        ...
        blurb:     "Siemens Layer-2 discovery telegram â€” PROFINET DCP (Discovery and Configuration Protocol) for NameOfStation assignment, IP parameter configuration, device identification, and factory reset operations at the Ethernet data link layer.",
    }
    TiaPortalOnlineDiag {
        ...
        blurb:     "TIA Portal online diagnostics â€” module status interrogation, rack/station topology queries, firmware version inventory, diagnostic buffer readout, and firmware update trigger frames exchanged between TIA Portal engineering station and Siemens automation devices.",
    }
    SiemensOpcUaModel {
        ...
        blurb:     "Siemens OPC UA Companion Model â€” Siemens-specific NodeId namespace mapping, device-specific variable type definitions, method call structures, and companion specification extensions for SIMATIC S7-1500 PLCs in the OPC UA information model.",
    }
    SiemensIndustrial5g {
        ...
        blurb:     "Siemens Industrial 5G â€” private 5G network management protocol for industrial campuses with Siemens-specific UPF (User Plane Function) configuration, NEF (Network Exposure Function) extensions for deterministic latency, and 5G TSN integration for time-critical control.",
    }
    ...
    EtherNetIpRockwell {
        ...
        blurb:     "Rockwell EtherNet/IP CIP extended services â€” Rockwell-specific Class 1 implicit messaging extensions for high-performance I/O, including multiple producer-consumer relationships, connection priority modulation, and extended forward-open service parameters beyond the ODVA specification.",
    }
    CipSafetyRockwell {
        ...
        blurb:     "Rockwell CIP Safety â€” GuardLogix-specific safety signature verification, safety timestamp synchronization, and SIL 3 safety connection management with dual-channel comparison and discrepancy time monitoring for fail-safe operation.",
    }
    PcccExtended {
        ...
        blurb:     "Allen-Bradley PCCC (Programmable Controller Communications Commands) â€” extended command set for PLC-5, SLC-500, and MicroLogix controllers including protected file read/write, file copy/fill, diagnostic counters, and online program changes beyond the basic PCCC command set.",
    }
    Df1FullDuplexExt {
        ...
        blurb:     "Allen-Bradley DF1 Full-Duplex â€” extended CRC/BCC error-checking modes with packet sequence numbering, extended status byte reporting, and multi-packet transfers for large block reads/writes on DH-485 and RS-232 serial links.",
    }
    Studio5000OnlineComm {
        ...
        blurb:     "Studio 5000 Logix Designer â€” online communication protocol for tag browsing, cross-reference queries, online rung editing (ladder logic), task/ program upload/download, and controller synchronization during live production without stopping the processor.",
    }
    FactorytalkViewHmi {
        ...
        blurb:     "FactoryTalk View Machine Edition â€” Rockwell HMI tag subscription protocol with cyclic tag value publishing, alarm/event notifications, data log queries for historical trends, and multi-client display session management for PanelView Plus terminals.",
    }
    StratixSwitchTelemetry {
        ...
        blurb:     "Rockwell Stratix Switch â€” CIP-based industrial Ethernet switch telemetry for port mirroring configuration, QoS policy deployment, ring health monitoring, and CIP-to-SNMP bridge integration on Stratix 5400/5700 managed switches powered by Cisco IOS.",
    }
    PowerflexDriveCip {
        ...
        blurb:     "Rockwell PowerFlex Drive â€” CIP energy object (Class 0x4E) for drive energy consumption monitoring, torque profiling, motor thermal capacity tracking, and Rockwell-specific drive configuration parameters for PowerFlex 525/527/755 series variable-frequency drives.",
    }
    ControlLogixBackplane {
        ...
        blurb:     "ControlLogix 1756 backplane â€” chassis-level bus protocol for multi-controller communication across the ControlLogix backplane, covering owner/observer controller relationships, redundant controller synchronization, and module-level health monitoring across standard/redundant chassis configurations.",
    }
    GuardIOSafety {
        ...
        blurb:     "Rockwell Guard I/O â€” safety module telemetry with per-channel individual diagnostics, discrepancy time monitoring for dual-channel inputs, safe-state output assertion, and SIL 3 certified communication integrity verification for distributed safety I/O modules on EtherNet/IP.",
    }
    ...
    EthercatBeckhoffMdp {
        ...
        blurb:     "Beckhoff EtherCAT MDP â€” Modular Device Profile with Beckhoff-specific CoE (CANopen over EtherCAT) object dictionary extensions for modular I/O configuration, distributed clock synchronization parameters, and vendor-specific startup parameters for EL-series EtherCAT terminals.",
    }
    EthercatSafetyBeckhoff {
        ...
        blurb:     "Beckhoff TwinSAFE â€” Fail Safe over EtherCAT (FSoE) safety protocol with Beckhoff safe logic editor connection validation, safety function block parameterization, and TwinSAFE group communication for distributed safe I/O and drive safety via the EL6900/EL6910 safety logic terminals.",
    }
    TwincatAdsDetail {
        ...
        blurb:     "Beckhoff TwinCAT ADS (Automation Device Specification) â€” detailed decode of the ADS command structure including AMS NetID routing between TwinCAT runtimes, sum commands for batch register access, device notification subscriptions, and symbolic access via the AMS router.",
    }
    TwincatRouterTelemetry {
        ...
        blurb:     "TwinCAT ADS Router telemetry â€” real-time task jitter measurement, cycle time exceedance notifications, CPU load monitoring per TwinCAT runtime, and communication load statistics for the AMS router diagnostic data stream used by the TwinCAT System Manager.",
    }
    TwincatScopeView {
        ...
        blurb:     "TwinCAT Scope View â€” multi-channel synchronized oscilloscope data acquisition protocol for real-time process variable recording, multi-axis synchronized chart capture, YX scatter plot streaming, and trigger-based scope acquisition across distributed TwinCAT runtimes.",
    }
    EthercatFoeDetail {
        ...
        blurb:     "EtherCAT FoE (File Access over EtherCAT) â€” detailed decode of firmware update operations using the Beckhoff bootloader protocol with flash segment mapping, file password authentication, CRC-32 integrity verification, and multi-segment firmware transfer for EtherCAT slaves.",
    }
    EthercatDistributedClocks {
        ...
        blurb:     "EtherCAT Distributed Clocks â€” detailed synchronization protocol for sub-microsecond clock alignment across all EtherCAT slaves including Beckhoff DC mode selection (free-run, SM-sync, DC-sync), drift compensation via system time propagation, and cycle time synchronization monitoring for coordinated motion control.",
    }
    BeckhoffXplanarMover {
        ...
        blurb:     "Beckhoff XPlanar â€” protocol for free-moving planar transport system with maglev mover position tracking, 6-DOF tilt sensing, collision domain management, trajectory planning commands, and wireless coil commutation data exchange for the XPlanar planar motor system.",
    }
    ...
    MitsubishiMelsecProto {
        ...
        blurb:     "Mitsubishi MELSEC MC (MELSEC Communication) protocol â€” binary and ASCII communication frames for iQ-R, iQ-F, and L-series PLCs with extended device memory map access (label access, intelligent function module buffers, multiple CPU shared memory), and online program monitoring.",
    }
    MitsubishiCcLinkIeField {
        ...
        blurb:     "Mitsubishi CC-Link IE Field basic extended protocol â€” cyclic and transient data exchange for Motion CPU and simple motion module network variables, with servo parameter access, synchronous axis control, and multiple CPU shared memory across CC-Link IE Field networks.",
    }
    OmronFinsUdpDetail {
        ...
        blurb:     "Omron FINS (Factory Interface Network Service) over UDP â€” extended command decode for Sysmac NJ/NX series controllers with CIP routing information, expanded memory area access beyond the standard FINS specification, and automatic clock synchronization via FINS frame exchange.",
    }
    KeyenceKvEthernet {
        ...
        blurb:     "Keyence KV-8000 and KV Nano series Ethernet protocol â€” PLC communication with ladder program upload/download, device memory read/write, remote run/stop control, and Keyence vision system trigger and inspection result relay over TCP/IP.",
    }
    BrAutomationPvi {
        ...
        blurb:     "B&R Automation PVI (Process Visualization Interface) â€” Automation Studio PVI transfer protocol for process variable access, cyclic data publication from the Automation Runtime, alarm handling, and device enumeration across B&R's POWERLINK and Ethernet networks.",
    }
    AbbRobotWebService {
        ...
        blurb:     "ABB Robot Web Services (RW 7.x) â€” RESTful bridge for RAPID-to-controller communication enabling motion data streaming, program upload/download, I/O signal monitoring, and real-time robot state subscription through the ABB controller's built-in web server.",
    }
    KukaRobotSensorInterface {
        ...
        blurb:     "KUKA Robot Sensor Interface (RSI) â€” real-time XML frame stream for sensor-guided robot motion with KUKA-specific sensor correction vectors, force/torque feedback integration, and position override commands transmitted cyclically over UDP at up to 1 kHz for closed-loop sensor-based robot control.",
    }
    FanucFocas2 {
        ...
        blurb:     "FANUC FOCAS2 (FANUC Open CNC API Specification 2) â€” CNC and PMC data window protocol for reading/writing CNC variables, tool offset tables, macro variables, alarm history, servo/spindle tuning parameters, and PMC register access across Ethernet for Series 0i/30i/31i/32i controllers.",
    }
    YaskawaMemobusTcpDetail {
        ...
        blurb:     "Yaskawa MEMOBUS/TCP â€” extended register access protocol for Yaskawa drive and motion controllers with Sigma-7 EtherCAT to MEMOBUS gateway bridging, inverter parameter access beyond standard Modbus addressing, and multi-drive register block reads over TCP port 502.",
    }
    BoschRexrothOpenCore {
        ...
        blurb:     "Bosch Rexroth Open Core Interface â€” cross-platform communication protocol for IndraMotion MLC/XLC controllers enabling app-to-app bridging between IEC 61131-3 PLC programs, high-level language applications (C++, Java, C#), and IIoT cloud connectivity through the Open Core Engineering interface.",
    }
}
...
fn builtin_category(p: &Protocol) -> Category {
    ...
    fn cat_names() -> &'static [(&'static [&'static str], Category)] {
        &[
            ...
            (
                &[
                    "Tls", "Dtls", "Isakmp", "Eapol", "Radius", "Diameter", "Kerberos", "Ldap",
                ],
                Category::Security,
            ),
        ]
...
impl Protocol {
    ...
    /// Convenience check â€” is this an AI/LLM API protocol?
...
mod tests {
    ...
    fn declared_status_matches_the_dispatch() {
        ...
        // A module the dispatch never reaches cannot produce anything, however
        // many `Protocol::X` its body contains â€” no packet arrives to run it.
        // Counting those files was why 140 rows could sit on `Dissected` while
        // being unreachable: each one vouched for itself.
        let unreachable = crate::dissectors::robustness::unreachable_modules();
        ...
        assert!(
            lying.is_empty(),
            "marked `status: Dissected` but no dissector assigns them â€” \
        ...
        assert!(
            ...
            "a dissector produces these, but `status: Declared` keeps them out of \
             the filter and the Learn tab â€” mark them `Dissected`: {hidden:?}"
        );
    }
