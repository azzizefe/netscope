...
- [ ] **2.1 — Welford Online Varyans Takipçisi (`WelfordTracker`)**  
...
- [ ] **2.2 — Z-Score Anomali Tespiti (`compute_z_score`)**  
...
- [ ] **2.3 — EWMA (Üssel Ağırlıklı Hareketli Ortalama) Takipçisi (`EwmaTracker`)**  
...
- [ ] **2.4 — 168 Slotlu Mevsimsel Baseline Matrisi**  
...
- [ ] **2.5 — IQR (Çeyrekler Arası Aralık) Aykırı Değer Filtresi**  
...
- [ ] **2.6 — Shannon Entropi Hesaplayıcısı (`calculate_shannon_entropy`)**  
...
- [ ] **2.7 — Kayan Pencere Frekans Analizörü (`SlidingWindowFrequencyAnalyzer`)**  
...
- [ ] **2.9 — IP Bazlı Baseline Profil Kayıt Motoru**  
...
- [ ] **2.10 — Subnet (Alt Ağ) Bazlı Toplu Anomali Tespiti**  
...
- [ ] **2.11 — Otomatik Baseline Güncellemesi**  
...
- [ ] **3.1 — Reconnaissance (Keşif) Haritalama**  
  Port taraması, servis keşfi → `T1595 - Active Scanning`, Kill Chain: `Recon`.

- [ ] **3.2 — Initial Access (İlk Erişim) Haritalama**  
...
- [ ] **4.1 — Suricata Kural Ayrıştırıcısı (`parse_rule`)**  
...
- [ ] **5.3 — 8 Ön Tanımlı Saldırı Kalıp Kütüphanesi (`AttackPatternDef`)**  
...
- [ ] **6.1 — Syslog RFC 5424 Çıktısı (UDP/TCP 514)**  
...
- [ ] **6.6 — Sigma Kuralları Dışa Aktarımı**  
...
- [ ] **7.3 — Admin Rolü Tam Yetki Kontrolü**  
...
- [ ] **7.4 — SOC Manager Yetki Sınırları**  
...
- [ ] **7.5 — Tier-1 Analist Minimal Yetki**  
...
- [ ] **7.6 — TOTP İki Faktörlü Doğrulama (MFA)**  
...
- [ ] **8.1 — Luhn Algoritması ile Kredi Kartı Tespiti & Maskeleme**  
...
- [ ] **8.7 — Otomatik Purge (Temizleme) Motoru**  
...
- [ ] **8.8 — AES-256-GCM Şifreleme (Encryption at Rest)**  
...
- [ ] **8.9 — KVKK/GDPR Unutulma Hakkı Silme Motoru**  
...
- [ ] **8.10 — Maskeleme Birim Test Doğrulaması**  
...
- [ ] **9.1 — SHA-256 Hash Zincirleme (Blockchain-Benzeri)**  
...
- [ ] **9.2 — Denetim Kaydı Veri Alanları (`AuditEntry`)**  
...
- [ ] **9.3 — Zincir Bütünlük Doğrulama (`verify_integrity`)**  
...
- [ ] **10.1 — ISO 27001:2022 Ek A Uyumluluk Denetçisi**  
...
- [ ] **10.2 — PCI-DSS 4.0 Uyumluluk Denetçisi**  
...
- [ ] **10.3 — GDPR / KVKK Uyumluluk Denetçisi**  
...
- [ ] **10.6 — MITRE ATT&CK Kapsama Matrisi**  
...
- [ ] **10.9 — Zamanlanmış Rapor Üretimi**  
...
- [ ] **11.7 — Hot SSD / Cold S3 Veri Katmanlama**  
...
- [ ] **11.8 — Tenant Context İzolasyonu (Multi-Tenancy)**  
...
- [ ] **13.1 — Birleşik Arama Motoru (Unified Search)**  
...
- [ ] **13.2 — Otomatik Tamamlama Önerileri (`AutocompleteSuggestions`)**  
  Arama yazarken IP'ler, hostnameler, protokoller, MITRE teknikleri ve olay tipleri için anlık öneri listesi.

- [ ] **13.3 — Arama Sonucu Açıklayıcısı ("Neden Bu Eşleşti?")**  
...
- [ ] **13.4 — Kayıtlı Filtre Şablonları (Saved Filter Templates)**  
...
- [ ] **13.6 — 1-Tık JA4 TLS Fingerprint Pivot**  
...
- [ ] **13.9 — Analist Gamifikasyon & Performans Metrikleri**  
...
> **Kaynak Modülleri:** [`test_strategy.rs`](../crates/core/src/test_strategy.rs), [`test_data.rs`](../crates/core/src/test_data.rs)  
...
- [ ] **14.5 — 100 Sensörlü Soak Test (7 Gün)**  
...
- [ ] **16.1 — İnteraktif SOC Oryantasyon Programı**  
...
- [ ] **16.2 — CTF (Capture The Flag) Laboratuvarı**  
...
- [ ] **16.3 — Threat Hunting Alıştırmaları**  
...
|---|---|---|---|---|
| 1 | Deterministik Triage & Risk Puanlama | 10 | 0 | ⬜ %0 |
| 2 | İstatistiksel Baseline & Anomali | 12 | 0 | ⬜ %0 |
| 3 | MITRE ATT&CK & Kill Chain | 8 | 0 | ⬜ %0 |
| 4 | Suricata Kural Motoru | 9 | 0 | ⬜ %0 |
| 5 | Naratif Korelasyon | 7 | 0 | ⬜ %0 |
| 6 | SIEM / SOAR Entegrasyonu | 10 | 0 | ⬜ %0 |
| 7 | RBAC, MFA, SSO & Güvenlik | 12 | 0 | ⬜ %0 |
| 8 | Veri Gizliliği & KVKK/GDPR | 10 | 0 | ⬜ %0 |
| 9 | Kriptografik Denetim Günlüğü | 6 | 0 | ⬜ %0 |
| 10 | Uyumluluk Raporlama | 9 | 0 | ⬜ %0 |
| 11 | HA, DR & Multi-Tenancy | 10 | 0 | ⬜ %0 |
| 12 | Bildirim & Webhook | 8 | 0 | ⬜ %0 |
| 13 | Analist Komut Merkezi & Eğitim | 9 | 0 | ⬜ %0 |
| 14 | Test Stratejisi & QA | 8 | 0 | ⬜ %0 |
| 15 | Kurumsal Dağıtım & IaC | 8 | 0 | ⬜ %0 |
| 16 | SOC Eğitim & NCSA Sertifikasyonu | 7 | 0 | ⬜ %0 |
| | **TOPLAM** | **143** | **0** | ⬜ **%0** |
