...
- [ ] **1.1. Deponun yedeğini alın:**
  ```bash
  git clone --mirror . ../netscope-mirror-backup.git
  ```
- [ ] **1.2. Geçmişteki `npcap-sdk` ve büyük binary dosyalarını temizleyin:**
  ```bash
  ...
  ```
- [ ] **1.3. Uzak depo adresini (remote) yeniden bağlayın:**
  ```bash
  git remote add origin https://github.com/azzizefe/netscope.git
  ```
- [ ] **1.4. Geçmişi force-push ile güncelleyin:**
  ```bash
...
- [ ] **2.1. Npcap SDK'yı yerel çalışma alanınıza indirin:**
...
- [ ] **3.1. 141 imzasız dissector modülüne tanıma fonksiyonu ekleyin:**
...
- [ ] **3.2. Çözümleyicileri dispatch tablosuna bağlayın:**
...
- [ ] **3.3. Testi aktifleştirin ve doğrulayın:**
...
- [ ] **4.1. Linux `nftables` desteğini ekleyin:**
...
- [ ] **4.2. macOS `pfctl` desteğini ekleyin:**
...
- [ ] **5.1. Eksik Tauri Komut Testlerini Yazın:**
...
- [ ] **5.2. Masaüstü testlerini koşturun:**
  ```bash
  cargo test -p netscope-desktop
  ```
- [ ] **5.3. Arayüz (Frontend) birim testlerini çalıştırın:**
...
- [ ] **6.1. Güvenli Ajan Güncellemesini Kurun:**
...
- [ ] **7.1. Kod İmzalama Sertifikasını Tanımlayın:**
  ...
  ```
- [ ] **7.2. Yükleyici Paketlerini Derleyin (MSI / NSIS):**
  ```bash
  cargo tauri build
  ```
- [ ] **7.3. Çıktı Paketlerini Manuel Test Edin:**
...
- [ ] **8.3. Sürüm Öncesi Kontrol Listesini Tamamlayın:**
